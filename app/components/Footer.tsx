...
const pages = [["How It Works", "/how-it-works"], ["Science", "/science"], ["Team", "/team"], ["Contact", "/contact"]] as const;
    ...
    <footer className="global-footer">
      <div className="footer-lead">
        <div>
          ...
          <h2>Cells. Material.<br />Delivery.</h2>
        </div>
      ...
      <div className="footer-grid">
        <div className="footer-statement"><p>A research-stage concept at the intersection of cell biology, biomaterials, and vascular design.</p><span>BioPancrea / Research-stage</span></div>
      ...
      <div className="footer-legal">
        ...
        <p>General corporate information only. The BioPancrea platform is investigational, is not approved for clinical use, and this website does not provide medical advice.</p>
      </div>
    </footer>
  );
}
