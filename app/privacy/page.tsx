...
export default function PrivacyPage() { return <LegalPage title="Privacy policy" intro="A clear overview of the limited information this website collects and why.">
  <h2>Information you provide</h2><p>When you use our contact form, we collect your name, email address, organisation if supplied, area of interest, message, and consent choice.</p>
  <h2>How information is used</h2><p>We use contact details only to review and respond to enquiries and manage expressions of interest. We do not sell personal information.</p>
  ...
  <h2>Your choices</h2><p>You may choose not to submit personal information. You may also request that an enquiry record be reviewed or removed once BioPancrea publishes an appropriate privacy contact channel.</p>
