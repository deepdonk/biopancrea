...
export default function PrivacyPage() { return <LegalPage title="Privacy policy" intro="A short overview of this website’s current privacy approach.">
  <h2>Information collection</h2><p>This website does not currently use a contact form, advertising cookies, or analytics tools. Contact takes place through the visitor’s own email application once a public BioPancrea address is confirmed.</p>
